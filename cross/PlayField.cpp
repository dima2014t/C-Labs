...
PlayField::fieldStatus PlayField::checkLineStatus(cellValue firstCell, cellValue secondCell, cellValue thirdСell) const
{
	if (firstCell == secondCell && secondCell == thirdСell && secondCell != csEmpty)
	{
